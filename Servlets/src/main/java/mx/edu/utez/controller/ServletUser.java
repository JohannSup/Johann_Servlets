...
public class ServletUser extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch(action){
            ...
            case "delete":
                // do something
                long id2 = Long.parseLong(request.getParameter(s: "id"));
                if(new DaoUser().delete(id2)){
                    request.setAttribute(s:"message", o:"Usuario eliminado correctamente");
                }else{
                    request.setAttribute(s: "message", o:"usuario no eliminado");
                }
                doGet(request, response);
                break;
            default:
